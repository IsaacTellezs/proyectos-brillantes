...
$query = "SELECT Nombre_proyecto, Imagen, Categorias  FROM proyectos WHERE Categorias = 'Social y sin fines de lucro'";; // Reemplaza 'proyectos' con el nombre de tu tabla
