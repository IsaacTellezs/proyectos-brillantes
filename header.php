...
<head>
    ...
    <link rel="icon" href="\crowd\images\logo simple.svg" type="image/svg">
</head>
<header id="top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-center ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="\crowd\contact.php">Contacto</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="\crowd\registro.php">Registrate como creador</a></li>

                                <li><a class="dropdown-item" href="\crowd\registroInversionista.php">Registrate como inversionista</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="\crowd\login.php">Inicia como creador</a>
                                </li>

                                <li>
                                    <a class="dropdown-item" href="\crowd\login-inversionista.php">Inicia como inversionista</a>
                                </li>

                                <li>
                                    <a class="dropdown-item" href="\crowd\login-admin.php">Inicia como administrador</a>
                                </li>
            </div>
        </nav>
    </header>
