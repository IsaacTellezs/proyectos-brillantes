            ...
            <section class="hero-section d-flex justify-content-center align-items-center">
                ...
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        ...
                        <form class="custom-form hero-form" action="funciones/iniciar-sesion-admin.php" method="post" role="form">
                                <h3 class="text-white mb-3 d-flex justify-content-center">Administrador</h3>
                                  <!-- Mensaje de error -->
                                <?php
                                if (isset($_GET['error'])) {
