                    ...
                    <ul class="navbar-nav align-items-center ms-lg-5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="GobiernoyServicios.html">Gobierno y servicios publicos</a></li>
                                ...
                                <div class="col-lg-12 col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi-person custom-icon"></i></span>
                                                <input type="number" class="form-control" id="edad" placeholder="Tu edad">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="email" class="form-label">Numero telefono</label>
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi-person custom-icon"></i></span>
                                                <input type="email" class="form-control" id="email" placeholder="Tu numero">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi-person custom-icon"></i></span>
                                                <textarea class="form-control" id="bio" rows="4" placeholder="Cuéntanos algo sobre ti"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-12">
