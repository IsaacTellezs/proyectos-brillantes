...
$query = "SELECT Nombre_proyecto, Imagen, Categorias, id_proyecto  FROM proyectos WHERE Categorias = 'Social y sin fines de lucro'";; // Reemplaza 'proyectos' con el nombre de tu tabla
