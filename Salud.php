                    ...
                    <ul class="navbar-nav align-items-center ms-lg-5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item active" href="job-listings.html">Salud.</a></li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h1 class="text-white">Proyectos sobre la salud.</h1>
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="images/jobs/mundo-abierto.jpg" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="job-details.html" class="job-title-link">Juego de aventuras en mundo abierto.</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="images/jobs/rol-epico.jpg" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="job-details.html" class="job-title-link">Juego de rol (RPG) épico.</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="images/jobs/tiempo-real.jpg" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="job-details.html" class="job-title-link">Juego de estrategia en tiempo real (RTS)</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="images/jobs/puzzles.jpg" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="job-details.html" class="job-title-link">Juego de puzzles desafiantes.</a>
                                    </h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="images/jobs/turnos.jpg" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="job-details.html" class="job-title-link">Juego de estrategia por turnos (TBS).</a>
                                    </h4>
