...
<html lang="en">
    <head>
        ...
        <title>Gobierno y servicios publicos </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="text-white">Proyectos de gobierno y servicios públicos.</h1>
            </div>
        </div>
    </div>
</header>
...
$query = "SELECT nom_proyecto, imagen, categoria, id_proyecto FROM proyectos WHERE categoria = 'Gobierno y servicios publicos'";
// Ejecuta la consulta
