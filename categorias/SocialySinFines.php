...
<html lang="en">
    <head>
        ...
        <title>Social y sin fines de lucro</title>
...
$query = "SELECT nom_proyecto, imagen, categoria, id_proyecto FROM proyectos WHERE categoria = 'Social y sin fines de lucro'";
// Ejecuta la consulta
