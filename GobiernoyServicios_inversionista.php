...
$query = "SELECT Nombre_proyecto, Imagen, Categorias, id_proyecto  FROM proyectos WHERE Categorias = 'Gobierno y servicios públicos'";; // Reemplaza 'proyectos' con el nombre de tu tabla
